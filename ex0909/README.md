...
- `/item/`, `/user/`, `/board/`처럼 기능별로 API를 나눠서 관리
- 각각 하나의 독립된 작은 앱처럼 구성할 수 있음
- FastAPI에서는 `APIRouter`를 사용
- `main.py`에서는 각 Router를 불러와서 연결

### 쉽게 기억

- Router = 기능별 출입구
- 프로젝트가 커질수록 기능별로 나눠서 관리
